window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-settings-plugins/src/client/fields.module.css.mjs
		const css$2 = ".m0g1za_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.m0g1za_field+.m0g1za_field{border-top:1px solid var(--dsw-alias-border-l2)}.m0g1za_head{align-items:center;gap:8px;display:flex}.m0g1za_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.m0g1za_badges{align-items:center;gap:8px;display:inline-flex}.m0g1za_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.m0g1za_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.m0g1za_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.m0g1za_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.m0g1za_reset:disabled{cursor:default}.m0g1za_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.m0g1za_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.m0g1za_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.m0g1za_inputInvalid{border-color:var(--dsw-alias-label-error);}.m0g1za_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.m0g1za_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"badge": "m0g1za_badge",
			"badgeMuted": "m0g1za_badgeMuted",
			"badges": "m0g1za_badges",
			"field": "m0g1za_field",
			"head": "m0g1za_head",
			"hint": "m0g1za_hint",
			"input": "m0g1za_input",
			"inputInvalid": "m0g1za_inputInvalid",
			"invalid": "m0g1za_invalid",
			"label": "m0g1za_label",
			"reset": "m0g1za_reset"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-settings-plugins/src/client/PluginCard.module.css.mjs
		const css$1 = ".JP23RW_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.JP23RW_card:hover{border-color:var(--dsw-alias-label-dimmed)}.JP23RW_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.JP23RW_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.JP23RW_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.JP23RW_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.JP23RW_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.JP23RW_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.JP23RW_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.JP23RW_chevronOpen{transform:rotate(180deg)}.JP23RW_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.JP23RW_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.JP23RW_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.JP23RW_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.JP23RW_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.JP23RW_discard,.JP23RW_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.JP23RW_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.JP23RW_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.JP23RW_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.JP23RW_discard:disabled,.JP23RW_save:disabled{opacity:.4;cursor:default}.JP23RW_discard:focus-visible,.JP23RW_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"body": "JP23RW_body",
			"card": "JP23RW_card",
			"cardOpen": "JP23RW_cardOpen",
			"chevron": "JP23RW_chevron",
			"chevronOpen": "JP23RW_chevronOpen",
			"description": "JP23RW_description",
			"discard": "JP23RW_discard",
			"failed": "JP23RW_failed",
			"footer": "JP23RW_footer",
			"headText": "JP23RW_headText",
			"header": "JP23RW_header",
			"name": "JP23RW_name",
			"pending": "JP23RW_pending",
			"readOnly": "JP23RW_readOnly",
			"save": "JP23RW_save"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.module.css.mjs
		const css = ".q_IRiG_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.q_IRiG_heading{margin:0;font-size:18px;font-weight:600}.q_IRiG_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.q_IRiG_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.q_IRiG_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.q_IRiG_tab:hover,.q_IRiG_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.q_IRiG_tab[data-active=true]:after,.q_IRiG_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.q_IRiG_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.q_IRiG_panel{min-width:0;padding-top:2px}.q_IRiG_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.q_IRiG_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"cards": "q_IRiG_cards",
			"empty": "q_IRiG_empty",
			"heading": "q_IRiG_heading",
			"intro": "q_IRiG_intro",
			"panel": "q_IRiG_panel",
			"section": "q_IRiG_section",
			"tab": "q_IRiG_tab",
			"tabs": "q_IRiG_tabs"
		};
		//#endregion
