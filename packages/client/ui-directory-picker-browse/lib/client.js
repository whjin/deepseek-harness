window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-directory-picker-browse/src/client/DirectoryBrowser.module.css.mjs
		const css = ".kt56rq_dialog.kt56rq_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.kt56rq_editorScope{display:contents}.kt56rq_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.kt56rq_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.kt56rq_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.kt56rq_crumbBar:has(.kt56rq_crumbEditZone:enabled:hover),.kt56rq_crumbBar:has(.kt56rq_crumbEditZone:focus-visible),.kt56rq_crumbBar:has(.kt56rq_pathInput){border-color:var(--dsw-alias-border-l2)}.kt56rq_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.kt56rq_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.kt56rq_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.kt56rq_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.kt56rq_crumb:hover{color:var(--dsw-alias-label-primary)}.kt56rq_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.kt56rq_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.kt56rq_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.kt56rq_crumbEditZone:enabled:hover .kt56rq_crumbEditGlyph,.kt56rq_crumbEditZone:focus-visible .kt56rq_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.kt56rq_crumbEditZone:disabled{cursor:default}.kt56rq_crumbEditZone:disabled .kt56rq_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.kt56rq_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.kt56rq_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.kt56rq_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.kt56rq_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.kt56rq_rowSeat{flex:none;display:flex}.kt56rq_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.kt56rq_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.kt56rq_rowSelected,.kt56rq_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.kt56rq_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.kt56rq_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.kt56rq_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.kt56rq_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.kt56rq_status,.kt56rq_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.kt56rq_status{color:var(--dsw-alias-label-secondary)}.kt56rq_error{color:var(--dsw-alias-state-error-primary)}.kt56rq_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.kt56rq_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.kt56rq_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.kt56rq_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.kt56rq_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.kt56rq_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.kt56rq_footerGap{flex:1 1 0}.kt56rq_footerAction{min-width:72px}.kt56rq_createDialog.kt56rq_createDialog{gap:0;width:min(380px,100%);padding:0}.kt56rq_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.kt56rq_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.kt56rq_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.kt56rq_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.kt56rq_createInput::placeholder{color:var(--dsw-alias-label-caption)}.kt56rq_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"column": "kt56rq_column",
			"content": "kt56rq_content",
			"createActions": "kt56rq_createActions",
			"createBody": "kt56rq_createBody",
			"createDialog": "kt56rq_createDialog",
			"createIn": "kt56rq_createIn",
			"createInput": "kt56rq_createInput",
			"createTitle": "kt56rq_createTitle",
			"crumb": "kt56rq_crumb",
			"crumbBar": "kt56rq_crumbBar",
			"crumbChevron": "kt56rq_crumbChevron",
			"crumbEditGlyph": "kt56rq_crumbEditGlyph",
			"crumbEditZone": "kt56rq_crumbEditZone",
			"crumbSeat": "kt56rq_crumbSeat",
			"crumbTrail": "kt56rq_crumbTrail",
			"dialog": "kt56rq_dialog",
			"divider": "kt56rq_divider",
			"editorScope": "kt56rq_editorScope",
			"error": "kt56rq_error",
			"footerAction": "kt56rq_footerAction",
			"footerBar": "kt56rq_footerBar",
			"footerGap": "kt56rq_footerGap",
			"header": "kt56rq_header",
			"loadingFloat": "kt56rq_loadingFloat",
			"millerRow": "kt56rq_millerRow",
			"pathInput": "kt56rq_pathInput",
			"row": "kt56rq_row",
			"rowChevron": "kt56rq_rowChevron",
			"rowIcon": "kt56rq_rowIcon",
			"rowIconSelected": "kt56rq_rowIconSelected",
			"rowName": "kt56rq_rowName",
			"rowSeat": "kt56rq_rowSeat",
			"rowSelected": "kt56rq_rowSelected",
			"showHiddenToggle": "kt56rq_showHiddenToggle",
			"showHiddenToggleActive": "kt56rq_showHiddenToggleActive",
			"status": "kt56rq_status",
			"title": "kt56rq_title"
		};
		//#endregion
