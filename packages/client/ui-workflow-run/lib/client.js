window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-workflow-run/src/client/WorkflowRunPanel.module.css.mjs
		const css = ".DmHNsq_root{width:100%;min-width:0}.DmHNsq_runHeader{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);border-radius:8px;align-items:center;gap:6px;width:100%;min-width:0;height:32px;padding:0 8px;display:flex}.DmHNsq_runHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.DmHNsq_runLeading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}.DmHNsq_runTitle{max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:14px;font-weight:510;line-height:24px;overflow:hidden}.DmHNsq_runSummary{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.DmHNsq_statusTail{height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex:none;align-items:center;gap:4px;font-size:11px;font-weight:510;line-height:16px;display:inline-flex;overflow:hidden}.DmHNsq_phaseHeader{box-sizing:border-box;align-items:center;gap:6px;width:100%;min-width:0;height:32px;display:flex}.DmHNsq_phaseHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px;border-radius:4px}.DmHNsq_phaseLeading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}.DmHNsq_phaseTitle{min-width:0;max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:14px;line-height:24px;overflow:hidden}.DmHNsq_phaseCount{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:20px;overflow:hidden}.DmHNsq_phaseStatus{width:132px;color:var(--dsw-alias-label-secondary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:13px;line-height:20px;overflow:hidden}.DmHNsq_separator{background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:2px;height:2px}.DmHNsq_phaseList{flex-direction:column;gap:4px;min-width:0;padding:4px 0 0 16px;display:flex}.DmHNsq_phase{min-width:0}.DmHNsq_members{flex-direction:column;gap:2px;min-width:0;padding:0 0 0 16px;display:flex}.DmHNsq_memberRow,.DmHNsq_memberButton{width:100%;min-width:0;min-height:24px;color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;background:0 0;border:0;border-radius:4px;align-items:center;gap:12px;padding:0;display:flex}.DmHNsq_memberButton{cursor:pointer}.DmHNsq_memberButton .DmHNsq_memberLabel{color:var(--dsw-alias-state-business-primary);text-underline-position:from-font;text-decoration:underline}.DmHNsq_dotSlot{flex:none;justify-content:center;align-items:center;width:16px;height:24px;display:inline-flex;overflow:hidden}.DmHNsq_memberButton:focus-visible{outline:none}.DmHNsq_memberButton:focus-visible .DmHNsq_memberLabelWrap{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.DmHNsq_memberLabelWrap{border-radius:4px;flex:1;align-items:center;min-width:0;height:24px;padding:0 2px;display:flex;overflow:hidden}.DmHNsq_memberLabel{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:14px;line-height:24px;overflow:hidden}.DmHNsq_memberStatus{width:64px;color:var(--dsw-alias-label-secondary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:13px;line-height:20px;overflow:hidden}.DmHNsq_empty{color:var(--dsw-alias-label-tertiary);padding:0;font-size:13px;line-height:20px}@media (width<=560px){.DmHNsq_phaseList,.DmHNsq_members{padding-left:12px}}";
		...
		var WorkflowRunPanel_module_css_default = {
			"dotSlot": "DmHNsq_dotSlot",
			"empty": "DmHNsq_empty",
			"memberButton": "DmHNsq_memberButton",
			"memberLabel": "DmHNsq_memberLabel",
			"memberLabelWrap": "DmHNsq_memberLabelWrap",
			"memberRow": "DmHNsq_memberRow",
			"memberStatus": "DmHNsq_memberStatus",
			"members": "DmHNsq_members",
			"phase": "DmHNsq_phase",
			"phaseCount": "DmHNsq_phaseCount",
			"phaseHeader": "DmHNsq_phaseHeader",
			"phaseLeading": "DmHNsq_phaseLeading",
			"phaseList": "DmHNsq_phaseList",
			"phaseStatus": "DmHNsq_phaseStatus",
			"phaseTitle": "DmHNsq_phaseTitle",
			"root": "DmHNsq_root",
			"runHeader": "DmHNsq_runHeader",
			"runLeading": "DmHNsq_runLeading",
			"runSummary": "DmHNsq_runSummary",
			"runTitle": "DmHNsq_runTitle",
			"separator": "DmHNsq_separator",
			"statusTail": "DmHNsq_statusTail"
		};
		//#endregion
