window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-skill/src/client/SkillRow.module.css.mjs
		const css = ".OFwqoG_card{flex-direction:column;display:flex}.OFwqoG_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.OFwqoG_row[data-expandable]{cursor:pointer}.OFwqoG_card[data-state=running] .OFwqoG_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite OFwqoG_dsh-skill-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes OFwqoG_dsh-skill-row-sweep{0%{left:-300px}90%,to{left:100%}}.OFwqoG_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.OFwqoG_chevron{color:var(--dsw-alias-label-secondary)}.OFwqoG_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.OFwqoG_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.OFwqoG_row:hover .OFwqoG_iconIdle{opacity:0}.OFwqoG_row:hover .OFwqoG_chevronHover{opacity:1}.OFwqoG_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.OFwqoG_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.OFwqoG_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.OFwqoG_errorSummary{color:var(--dsw-alias-state-error-primary)}.OFwqoG_bodyWrap{flex-direction:column;display:flex}.OFwqoG_instructionsCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:12px;flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:hidden}.OFwqoG_instructionsHeader{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:8px 12px;font-size:11px;font-weight:500;line-height:16px}.OFwqoG_instructions{white-space:pre-wrap;overflow-wrap:anywhere;min-height:0;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:10px 12px 12px;overflow:auto}.OFwqoG_instructions[data-error]{color:var(--dsw-alias-state-error-primary)}.OFwqoG_instructions::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.OFwqoG_instructions::-webkit-scrollbar-track{margin:6px 0}.OFwqoG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.OFwqoG_card:hover .OFwqoG_inspectButton,.OFwqoG_inspectButton:focus-visible{opacity:1}.OFwqoG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.OFwqoG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.OFwqoG_card[data-state=running] .OFwqoG_row:after{animation:none;display:none}.OFwqoG_iconIdle,.OFwqoG_chevronHover,.OFwqoG_inspectButton{transition:none}}";
		...
		var SkillRow_module_css_default = {
			"bodyWrap": "OFwqoG_bodyWrap",
			"card": "OFwqoG_card",
			"chevron": "OFwqoG_chevron",
			"chevronHover": "OFwqoG_chevronHover",
			"dsh-skill-row-sweep": "OFwqoG_dsh-skill-row-sweep",
			"errorSummary": "OFwqoG_errorSummary",
			"iconIdle": "OFwqoG_iconIdle",
			"inspectButton": "OFwqoG_inspectButton",
			"instructions": "OFwqoG_instructions",
			"instructionsCard": "OFwqoG_instructionsCard",
			"instructionsHeader": "OFwqoG_instructionsHeader",
			"leading": "OFwqoG_leading",
			"row": "OFwqoG_row",
			"separator": "OFwqoG_separator",
			"summary": "OFwqoG_summary",
			"title": "OFwqoG_title",
			"visuallyHidden": "OFwqoG_visuallyHidden"
		};
		//#endregion
