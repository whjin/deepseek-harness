window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-user-questions/src/client/PlanReviewPanel.module.css.mjs
		const css$1 = ".nFFawG_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.nFFawG_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.nFFawG_card,.nFFawG_card *{box-sizing:border-box}.nFFawG_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.nFFawG_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.nFFawG_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.nFFawG_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.nFFawG_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.nFFawG_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.nFFawG_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.nFFawG_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.nFFawG_card{border-radius:16px}.nFFawG_body{padding:10px 12px 4px}.nFFawG_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"actions": "nFFawG_actions",
			"body": "nFFawG_body",
			"card": "nFFawG_card",
			"discuss": "nFFawG_discuss",
			"dot": "nFFawG_dot",
			"feedback": "nFFawG_feedback",
			"footer": "nFFawG_footer",
			"frame": "nFFawG_frame",
			"strip": "nFFawG_strip"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-user-questions/src/client/QuestionComposer.module.css.mjs
		const css = ".ntYR1a_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.ntYR1a_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.ntYR1a_card,.ntYR1a_card *{box-sizing:border-box}.ntYR1a_cardMinimized{max-height:none}.ntYR1a_cardMinimized .ntYR1a_header{padding-bottom:14px}.ntYR1a_headerActions{flex-shrink:0;align-items:center;gap:4px;display:flex}.ntYR1a_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.ntYR1a_headingBlock{min-width:0}.ntYR1a_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.ntYR1a_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.ntYR1a_detail{margin:0 2px 8px}.ntYR1a_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.ntYR1a_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.ntYR1a_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.ntYR1a_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.ntYR1a_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.ntYR1a_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.ntYR1a_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.ntYR1a_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.ntYR1a_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.ntYR1a_option:hover:not(:disabled),.ntYR1a_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.ntYR1a_optionSelected{border-color:var(--dsw-alias-border-l2)}.ntYR1a_option:disabled{cursor:default}.ntYR1a_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.ntYR1a_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.ntYR1a_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.ntYR1a_checkbox>svg{grid-area:1/1}.ntYR1a_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.ntYR1a_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.ntYR1a_optionCopy{flex:1;min-width:0}.ntYR1a_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.ntYR1a_optionLabel{font-size:14px;font-weight:500;line-height:24px}.ntYR1a_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.ntYR1a_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.ntYR1a_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.ntYR1a_customRow:hover,.ntYR1a_customRow:focus-within,.ntYR1a_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.ntYR1a_customRow:focus-within,.ntYR1a_customRowActive{border-color:var(--dsw-alias-border-l2)}.ntYR1a_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}.ntYR1a_customInput::placeholder{color:var(--dsw-alias-label-caption)}.ntYR1a_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}.ntYR1a_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}.ntYR1a_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}.ntYR1a_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.ntYR1a_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.ntYR1a_card{border-radius:16px}.ntYR1a_header{padding:10px 12px 0 18px}.ntYR1a_options{padding:4px 8px}.ntYR1a_title{font-size:15px;line-height:21px}.ntYR1a_option,.ntYR1a_customRow{padding:8px 6px}.ntYR1a_footer{align-items:flex-end;padding:0 10px}.ntYR1a_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.ntYR1a_option,.ntYR1a_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			...
			"body": "ntYR1a_body",
			"card": "ntYR1a_card",
			"cardMinimized": "ntYR1a_cardMinimized",
			"checkbox": "ntYR1a_checkbox",
			"checkboxChecked": "ntYR1a_checkboxChecked",
			"customInput": "ntYR1a_customInput",
			"customRow": "ntYR1a_customRow",
			"customRowActive": "ntYR1a_customRowActive",
			"customTextarea": "ntYR1a_customTextarea",
			"description": "ntYR1a_description",
			"detail": "ntYR1a_detail",
			"eyebrow": "ntYR1a_eyebrow",
			"feedback": "ntYR1a_feedback",
			"footer": "ntYR1a_footer",
			"footerActions": "ntYR1a_footerActions",
			"frame": "ntYR1a_frame",
			"header": "ntYR1a_header",
			"headerActions": "ntYR1a_headerActions",
			"headingBlock": "ntYR1a_headingBlock",
			"iconButton": "ntYR1a_iconButton",
			"number": "ntYR1a_number",
			"option": "ntYR1a_option",
			"optionCopy": "ntYR1a_optionCopy",
			"optionLabel": "ntYR1a_optionLabel",
			"optionLine": "ntYR1a_optionLine",
			"optionSelected": "ntYR1a_optionSelected",
			"options": "ntYR1a_options",
			"pager": "ntYR1a_pager",
			"progress": "ntYR1a_progress",
			"title": "ntYR1a_title"
		};
		//#endregion
