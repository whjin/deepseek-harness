window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".FlUOHW_projectRow,.FlUOHW_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.FlUOHW_projectRow:hover,.FlUOHW_sessionRow:hover,.FlUOHW_sessionRow.FlUOHW_selected{background:var(--dsw-alias-interactive-bg-hover)}.FlUOHW_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.FlUOHW_searchResultRow:hover,.FlUOHW_searchResultRow.FlUOHW_selected{background:var(--dsw-alias-interactive-bg-hover)}.FlUOHW_searchResultHeading{align-items:center;min-width:0;display:flex}.FlUOHW_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.FlUOHW_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.FlUOHW_searchResultWorkspace,.FlUOHW_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.FlUOHW_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.FlUOHW_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.FlUOHW_projectRow{box-sizing:border-box;align-items:center;height:34px}.FlUOHW_projectRow .FlUOHW_rowActions{height:20px}.FlUOHW_sessionRow{height:32px;animation:FlUOHW_row-in .15s var(--ds-ease-in-out);gap:0}.FlUOHW_sessionRow .FlUOHW_title{margin:0 6px 0 4px}.FlUOHW_flatSessionRowWithoutStatus .FlUOHW_title{margin-left:0}@keyframes FlUOHW_row-in{0%{opacity:0}}.FlUOHW_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.FlUOHW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.FlUOHW_folderActive{color:var(--dsw-alias-state-business-primary)}.FlUOHW_projectRow .FlUOHW_chevron{display:none}.FlUOHW_projectRow:hover .FlUOHW_chevron{display:inline-flex}.FlUOHW_projectRow:hover .FlUOHW_folder{display:none}.FlUOHW_arrow{transition:transform .15s var(--ds-ease-in-out)}.FlUOHW_arrowOpen{transform:rotate(90deg)}.FlUOHW_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.FlUOHW_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.FlUOHW_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.FlUOHW_sessionRow .FlUOHW_title{flex:1}.FlUOHW_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.FlUOHW_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.FlUOHW_dot{flex:none}.FlUOHW_rowActions{flex:none;align-items:center;gap:12px;display:none}.FlUOHW_projectRow:hover .FlUOHW_rowActions,.FlUOHW_sessionRow:hover .FlUOHW_rowActions,.FlUOHW_projectRow.FlUOHW_menuOpen .FlUOHW_rowActions,.FlUOHW_sessionRow.FlUOHW_menuOpen .FlUOHW_rowActions{display:inline-flex}.FlUOHW_sessionRow:hover .FlUOHW_time,.FlUOHW_sessionRow.FlUOHW_menuOpen .FlUOHW_time{display:none}.FlUOHW_projectRow.FlUOHW_menuOpen,.FlUOHW_sessionRow.FlUOHW_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.FlUOHW_sessionRow.FlUOHW_dropBefore,.FlUOHW_sessionRow.FlUOHW_dropAfter{position:relative}.FlUOHW_sessionRow.FlUOHW_dropBefore:before,.FlUOHW_sessionRow.FlUOHW_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.FlUOHW_sessionRow.FlUOHW_dropBefore:before{top:-7px}.FlUOHW_sessionRow.FlUOHW_dropAfter:after{bottom:-7px}.FlUOHW_hoverContent{flex-direction:column;gap:8px;display:flex}.FlUOHW_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.FlUOHW_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.FlUOHW_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.FlUOHW_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.FlUOHW_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.FlUOHW_iconButton:hover{color:var(--dsw-alias-label-primary)}.FlUOHW_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.FlUOHW_sessionRow,.FlUOHW_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"arrow": "FlUOHW_arrow",
			"arrowOpen": "FlUOHW_arrowOpen",
			"chevron": "FlUOHW_chevron",
			"dot": "FlUOHW_dot",
			"dropAfter": "FlUOHW_dropAfter",
			"dropBefore": "FlUOHW_dropBefore",
			"flatSessionRowWithoutStatus": "FlUOHW_flatSessionRowWithoutStatus",
			"folder": "FlUOHW_folder",
			"folderActive": "FlUOHW_folderActive",
			"hoverContent": "FlUOHW_hoverContent",
			"hoverPath": "FlUOHW_hoverPath",
			"hoverStatus": "FlUOHW_hoverStatus",
			"hoverTime": "FlUOHW_hoverTime",
			"hoverTitle": "FlUOHW_hoverTitle",
			"iconButton": "FlUOHW_iconButton",
			"menuOpen": "FlUOHW_menuOpen",
			"meta": "FlUOHW_meta",
			"projectRow": "FlUOHW_projectRow",
			"projectText": "FlUOHW_projectText",
			"renameInput": "FlUOHW_renameInput",
			"row-in": "FlUOHW_row-in",
			"rowActions": "FlUOHW_rowActions",
			"searchResultHeading": "FlUOHW_searchResultHeading",
			"searchResultMeta": "FlUOHW_searchResultMeta",
			"searchResultRow": "FlUOHW_searchResultRow",
			"searchResultSnippet": "FlUOHW_searchResultSnippet",
			"searchResultTitle": "FlUOHW_searchResultTitle",
			"searchResultWorkspace": "FlUOHW_searchResultWorkspace",
			"selected": "FlUOHW_selected",
			"sessionRow": "FlUOHW_sessionRow",
			"slot": "FlUOHW_slot",
			"time": "FlUOHW_time",
			"title": "FlUOHW_title",
			"visuallyHidden": "FlUOHW_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = ".q9Z1dG_modalAction{min-width:72px}.q9Z1dG_modalError,.q9Z1dG_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.q9Z1dG_modalError{color:var(--dsw-alias-state-error-primary)}.q9Z1dG_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "q9Z1dG_menuStatus",
			"modalAction": "q9Z1dG_modalAction",
			"modalError": "q9Z1dG_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-workspace/src/client/WorkspaceBrowser.module.css.mjs
		const css = ".eWPrsW_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.eWPrsW_root.eWPrsW_rail{padding-right:0}.eWPrsW_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.eWPrsW_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.eWPrsW_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.eWPrsW_root:not(.eWPrsW_rail) .eWPrsW_sectionHeader{margin-top:2px;margin-right:-4px}.eWPrsW_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.eWPrsW_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.eWPrsW_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.eWPrsW_searchSlotExpanded{max-width:100%;padding-left:0}.eWPrsW_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.eWPrsW_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.eWPrsW_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.eWPrsW_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.eWPrsW_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.eWPrsW_searchExpanded .eWPrsW_searchButton{width:28px;height:30px}.eWPrsW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.eWPrsW_searchExpanded .eWPrsW_searchButton:hover{background:0 0}.eWPrsW_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.eWPrsW_searchExpanded .eWPrsW_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.eWPrsW_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.eWPrsW_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.eWPrsW_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.eWPrsW_rail .eWPrsW_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.eWPrsW_rail .eWPrsW_headerActions{max-width:none}.eWPrsW_rail .eWPrsW_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.eWPrsW_rail .eWPrsW_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.eWPrsW_rail .eWPrsW_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.eWPrsW_rail .eWPrsW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.eWPrsW_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.eWPrsW_rail .eWPrsW_listArea{margin-left:0;margin-right:0;padding-left:0}.eWPrsW_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.eWPrsW_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.eWPrsW_wide{animation:eWPrsW_wide-in .2s var(--ds-ease-in-out)}@keyframes eWPrsW_wide-in{0%{opacity:0}}.eWPrsW_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.eWPrsW_flatList>*+*,.eWPrsW_searchTree>[role=treeitem]+[role=treeitem],.eWPrsW_groupSection>*+*{margin-top:2px}.eWPrsW_searchStatus,.eWPrsW_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.eWPrsW_searchWarning{color:var(--dsw-alias-label-secondary)}.eWPrsW_groupSection{position:relative}.eWPrsW_groupSection+.eWPrsW_groupSection{margin-top:4px}.eWPrsW_listTopDropIndicator,.eWPrsW_workspaceDropBefore:before,.eWPrsW_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.eWPrsW_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.eWPrsW_listTopDropActive>.eWPrsW_workspaceDropBefore:first-child:before{display:none}.eWPrsW_workspaceDropBefore:before{top:-8px}.eWPrsW_workspaceDropAfter:after{bottom:-8px}.eWPrsW_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.eWPrsW_groupSection>.eWPrsW_sessionOverflowButton{margin-top:0}.eWPrsW_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.eWPrsW_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.eWPrsW_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.eWPrsW_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.eWPrsW_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.eWPrsW_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.eWPrsW_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.eWPrsW_wide{animation:none}.eWPrsW_search,.eWPrsW_sectionLabel,.eWPrsW_searchSlot,.eWPrsW_searchInput,.eWPrsW_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "eWPrsW_clearButton",
			"deleteAction": "eWPrsW_deleteAction",
			"deleteStatus": "eWPrsW_deleteStatus",
			"empty": "eWPrsW_empty",
			"fade": "eWPrsW_fade",
			"flatList": "eWPrsW_flatList",
			"groupSection": "eWPrsW_groupSection",
			"headerActions": "eWPrsW_headerActions",
			"headerActionsHidden": "eWPrsW_headerActionsHidden",
			"iconButton": "eWPrsW_iconButton",
			"list": "eWPrsW_list",
			"listArea": "eWPrsW_listArea",
			"listTopDropActive": "eWPrsW_listTopDropActive",
			"listTopDropIndicator": "eWPrsW_listTopDropIndicator",
			"rail": "eWPrsW_rail",
			"renameError": "eWPrsW_renameError",
			"renameInput": "eWPrsW_renameInput",
			"root": "eWPrsW_root",
			"search": "eWPrsW_search",
			"searchButton": "eWPrsW_searchButton",
			"searchExpanded": "eWPrsW_searchExpanded",
			"searchInput": "eWPrsW_searchInput",
			"searchSlot": "eWPrsW_searchSlot",
			"searchSlotExpanded": "eWPrsW_searchSlotExpanded",
			"searchStatus": "eWPrsW_searchStatus",
			"searchTree": "eWPrsW_searchTree",
			"searchWarning": "eWPrsW_searchWarning",
			"sectionHeader": "eWPrsW_sectionHeader",
			"sectionLabel": "eWPrsW_sectionLabel",
			"sectionLabelHidden": "eWPrsW_sectionLabelHidden",
			"sessionOverflowButton": "eWPrsW_sessionOverflowButton",
			"treeBody": "eWPrsW_treeBody",
			"wide": "eWPrsW_wide",
			"wide-in": "eWPrsW_wide-in",
			"workspaceDropAfter": "eWPrsW_workspaceDropAfter",
			"workspaceDropBefore": "eWPrsW_workspaceDropBefore"
		};
		//#endregion
