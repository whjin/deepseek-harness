window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-message-feedback/src/client/MessageFeedbackActions.module.css.mjs
		const css = ".gu3fAW_action{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.gu3fAW_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.gu3fAW_action:disabled{cursor:default;opacity:.4}.gu3fAW_action[data-active]{color:var(--dsw-alias-label-primary)}.gu3fAW_noteOpen{max-width:220px;color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:14px;padding:0 8px;font-size:13px;line-height:28px;overflow:hidden}.gu3fAW_noteOpen:hover,.gu3fAW_noteOpen[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.gu3fAW_notePanel{z-index:1100;box-sizing:border-box;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:320px;max-width:min(360px,100vw - 24px);max-height:calc(100vh - 24px);box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;gap:8px;padding:8px;display:flex;position:fixed;overflow-y:auto}.gu3fAW_noteInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;color:var(--dsw-alias-label-primary);font:inherit;resize:vertical;border-radius:8px;padding:6px 8px;font-size:13px}.gu3fAW_noteActions{justify-content:flex-end;gap:6px;display:flex}.gu3fAW_noteSave,.gu3fAW_noteCancel{cursor:pointer;border:none;border-radius:14px;height:28px;padding:0 10px;font-size:13px}.gu3fAW_noteSave{background:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-foreground)}.gu3fAW_noteSave:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}.gu3fAW_noteSave:disabled{cursor:default;opacity:.4}.gu3fAW_noteCancel{color:var(--dsw-alias-label-tertiary);background:0 0}.gu3fAW_noteCancel:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.gu3fAW_failure{color:var(--dsw-alias-label-tertiary);padding-left:4px;font-size:13px;line-height:20px}";
		...
		var MessageFeedbackActions_module_css_default = {
			"action": "gu3fAW_action",
			"failure": "gu3fAW_failure",
			"noteActions": "gu3fAW_noteActions",
			"noteCancel": "gu3fAW_noteCancel",
			"noteInput": "gu3fAW_noteInput",
			"noteOpen": "gu3fAW_noteOpen",
			"notePanel": "gu3fAW_notePanel",
			"noteSave": "gu3fAW_noteSave"
		};
		//#endregion
