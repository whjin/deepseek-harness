window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-attachment/src/AttachmentRail.module.css.mjs
		const css$4 = "._7DbwhW_root{min-width:0;position:relative}._7DbwhW_rail{scrollbar-width:none;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:10px;display:flex;overflow:auto hidden}._7DbwhW_rail::-webkit-scrollbar{display:none}._7DbwhW_item{flex:0 0 64px;width:64px;height:64px;position:relative}._7DbwhW_thumbnail{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;width:64px;height:64px;padding:0;overflow:hidden}._7DbwhW_thumbnail img{object-fit:cover;width:100%;height:100%;display:block}._7DbwhW_remove{z-index:1;background:var(--dsw-alias-button-contrast-fill);width:18px;height:18px;color:var(--dsw-alias-label-primary-inverted);cursor:pointer;opacity:0;border:none;border-radius:50%;place-items:center;padding:0;transition:opacity .2s ease-in-out;display:grid;position:absolute;top:4px;right:4px}._7DbwhW_item:hover ._7DbwhW_remove,._7DbwhW_remove:focus-visible{opacity:1}@media (pointer:coarse){._7DbwhW_remove{opacity:1}}@media (prefers-reduced-motion:reduce){._7DbwhW_remove{transition:none}}._7DbwhW_arrow{z-index:2;border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);width:24px;height:24px;color:var(--dsw-alias-label-secondary);box-shadow:var(--dsw-shadow-lv2);cursor:pointer;border-radius:999px;place-items:center;padding:0;display:grid;position:absolute;top:50%;transform:translateY(-50%)}._7DbwhW_arrow:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}._7DbwhW_arrowLeft{left:4px}._7DbwhW_arrowRight{right:4px}";
		...
		var AttachmentRail_module_css_default = {
			"arrow": "_7DbwhW_arrow",
			"arrowLeft": "_7DbwhW_arrowLeft",
			"arrowRight": "_7DbwhW_arrowRight",
			"item": "_7DbwhW_item",
			"rail": "_7DbwhW_rail",
			"remove": "_7DbwhW_remove",
			"root": "_7DbwhW_root",
			"thumbnail": "_7DbwhW_thumbnail"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-attachment/src/DropOverlay.module.css.mjs
		const css$3 = "._2XbRFW_mask{z-index:1000;pointer-events:none;background-color:var(--dsw-alias-bg-mask-drop);backdrop-filter:blur(10px);justify-content:center;align-items:center;animation:.16s ease-out _2XbRFW_fade-in;display:flex;position:fixed;inset:0}@keyframes _2XbRFW_fade-in{0%{opacity:0}to{opacity:1}}@media (prefers-reduced-motion:reduce){._2XbRFW_mask{animation:none}}._2XbRFW_wrap{color:var(--dsw-alias-label-primary);text-align:center;flex-direction:column;align-items:center;margin-top:-3%;padding:0 40px;display:flex}._2XbRFW_illustration{width:115px;height:84px}._2XbRFW_title{font:var(--dsw-font-l-20);margin-top:16px}._2XbRFW_desc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;margin-top:16px}";
		...
		var DropOverlay_module_css_default = {
			"desc": "_2XbRFW_desc",
			"fade-in": "_2XbRFW_fade-in",
			"illustration": "_2XbRFW_illustration",
			"mask": "_2XbRFW_mask",
			"title": "_2XbRFW_title",
			"wrap": "_2XbRFW_wrap"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-attachment/src/ImageLightbox.module.css.mjs
		const css$2 = ".wo1vlq_backdrop{z-index:1000;place-items:center;padding:40px;display:grid;position:fixed;inset:0}.wo1vlq_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.wo1vlq_image{object-fit:contain;background:var(--dsw-specific-input-major);max-width:min(100%,1600px);max-height:calc(100vh - 80px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;position:relative}.wo1vlq_close{z-index:1;border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);width:36px;height:36px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;place-items:center;display:grid;position:fixed;top:20px;right:20px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-attachment/src/client/ComposerAttachments.module.css.mjs
		const css$1 = ".j6MCvW_rail{min-width:0;padding:4px 12px 0}";
		...
		var ComposerAttachments_module_css_default = { "rail": "j6MCvW_rail" };
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-attachment/src/MessageImage.module.css.mjs
		const css = ".dTEF1a_gallery{flex-wrap:wrap;gap:10px;max-width:100%;display:flex}.dTEF1a_gallery[data-align=end]{justify-content:flex-end;align-self:flex-end}.dTEF1a_gallery[data-align=start]{justify-content:flex-start;align-self:flex-start}.dTEF1a_frame{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;flex:none;place-items:center;min-width:44px;min-height:44px;padding:0;display:grid;overflow:hidden}.dTEF1a_frame[data-variant=tile]{width:64px;min-width:64px;height:64px;min-height:64px}.dTEF1a_frame img{object-fit:cover;width:100%;height:100%;display:block}.dTEF1a_loading,.dTEF1a_error{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.dTEF1a_error{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover-danger);cursor:pointer;border-radius:10px;max-width:240px;padding:10px 12px}.dTEF1a_error[data-variant=tile]{border-radius:16px;width:64px;height:64px;padding:4px;overflow:hidden}";
		...
		var MessageImage_module_css_default = {
			"error": "dTEF1a_error",
			"frame": "dTEF1a_frame",
			"gallery": "dTEF1a_gallery",
			"loading": "dTEF1a_loading"
		};
		//#endregion
