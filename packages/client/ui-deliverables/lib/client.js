window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-deliverables/src/client/ProducedFiles.module.css.mjs
		const css = ".UKXo2a_root{grid-template-columns:max-content minmax(0,1fr);align-items:center;gap:6px 8px;margin-top:16px;font-size:13px;line-height:22px;display:grid;position:relative}.UKXo2a_label{color:var(--dsw-alias-label-tertiary);grid-area:1/1}.UKXo2a_row{flex-wrap:nowrap;grid-area:1/2;align-items:center;gap:8px;min-width:0;display:flex;overflow:hidden}.UKXo2a_file{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-interactive-bg-hover);max-width:320px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:none;border-radius:6px;flex:none;margin:0;padding:0 8px;overflow:hidden}.UKXo2a_file:hover{color:var(--dsw-alias-label-primary);text-decoration:underline}.UKXo2a_file:focus-visible,.UKXo2a_showFolder:focus-visible{box-shadow:inset 0 0 0 2px var(--dsw-alias-border-l3);outline:none}.UKXo2a_more{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none}.UKXo2a_showFolder{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:4px;grid-area:2/2;justify-self:start;margin:0;padding:0 2px;line-height:20px}.UKXo2a_showFolder:hover{color:var(--dsw-alias-label-secondary);text-decoration:underline}.UKXo2a_measure{visibility:hidden;pointer-events:none;contain:strict;width:0;height:0;position:absolute;overflow:hidden}.UKXo2a_probe{width:max-content;position:absolute;inset:0 auto auto 0}";
		...
		var ProducedFiles_module_css_default = {
			"file": "UKXo2a_file",
			"label": "UKXo2a_label",
			"measure": "UKXo2a_measure",
			"more": "UKXo2a_more",
			"probe": "UKXo2a_probe",
			"root": "UKXo2a_root",
			"row": "UKXo2a_row",
			"showFolder": "UKXo2a_showFolder"
		};
		//#endregion
