window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-trajectory/src/client/TrajectoryTable.module.css.mjs
		const css$3 = ".SdAB6W_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.SdAB6W_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:SdAB6W_trajectory-table/inline-size}.SdAB6W_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.SdAB6W_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.SdAB6W_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite SdAB6W_history-loading-spin}.SdAB6W_table tbody .SdAB6W_historyLoadRow td{height:30px;padding:0}.SdAB6W_table tbody .SdAB6W_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.SdAB6W_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.SdAB6W_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.SdAB6W_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.SdAB6W_historyLoadButton:disabled{cursor:default}.SdAB6W_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.SdAB6W_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes SdAB6W_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.SdAB6W_historyLoadingSpinner{animation:none}}.SdAB6W_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.SdAB6W_eventColumn{width:122px}.SdAB6W_contentColumn{width:auto}.SdAB6W_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.SdAB6W_eventHeader{text-align:right!important;padding-right:4px!important}.SdAB6W_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.SdAB6W_table tbody .SdAB6W_virtualSpacer{pointer-events:none}.SdAB6W_table tbody .SdAB6W_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.SdAB6W_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.SdAB6W_table tbody tr[data-timeline-focus=outside]{opacity:.24}.SdAB6W_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.SdAB6W_table tbody tr[data-request-only=true]:hover{background:0 0}.SdAB6W_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.SdAB6W_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.SdAB6W_table tbody tr[data-request-only=true] .SdAB6W_turnRail{top:-15px;bottom:0}.SdAB6W_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.SdAB6W_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.SdAB6W_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.SdAB6W_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.SdAB6W_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.SdAB6W_requestBoundaryControl:hover:before,.SdAB6W_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.SdAB6W_requestBoundaryControlActive:before,.SdAB6W_requestBoundaryControlActive:hover:before,.SdAB6W_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.SdAB6W_requestBoundaryControl[data-request-status=error]:before,.SdAB6W_requestBoundaryControl[data-request-status=error]:hover:before,.SdAB6W_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.SdAB6W_requestBoundaryControl:hover:after,.SdAB6W_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.SdAB6W_requestBoundaryControl:focus-visible{outline:none}.SdAB6W_table tbody tr:has(.SdAB6W_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.SdAB6W_event{position:relative}.SdAB6W_turnRail,.SdAB6W_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.SdAB6W_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.SdAB6W_table tbody tr[data-turn-end=true] .SdAB6W_turnRail{bottom:0}.SdAB6W_selectionRail{z-index:5;width:3px;top:0;bottom:0}.SdAB6W_table tbody tr[data-error=true] .SdAB6W_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.SdAB6W_table tbody tr[data-error=true] .SdAB6W_selectionRail{background:var(--dsw-alias-state-error-primary)}.SdAB6W_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.SdAB6W_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.SdAB6W_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.SdAB6W_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.SdAB6W_turnLabelFull,.SdAB6W_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.SdAB6W_turnLabelCompact{opacity:0;max-width:0}.SdAB6W_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.SdAB6W_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.SdAB6W_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.SdAB6W_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.SdAB6W_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.SdAB6W_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.SdAB6W_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.SdAB6W_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.SdAB6W_table .SdAB6W_kindSlot .SdAB6W_message{justify-content:center;width:100%}@container SdAB6W_trajectory-table (width<=620px){.SdAB6W_eventColumn{width:50px}.SdAB6W_event{padding-left:28px!important;padding-right:3px!important}.SdAB6W_requestBoundaryControl{--request-boundary-base-left:6px}.SdAB6W_kindSlot{width:19px}.SdAB6W_kindTag,.SdAB6W_table .SdAB6W_kindSlot .SdAB6W_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.SdAB6W_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.SdAB6W_kindTagLabel,.SdAB6W_turnLabelFull{opacity:0;max-width:0}.SdAB6W_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.SdAB6W_eventColumn,.SdAB6W_event,.SdAB6W_requestBoundaryControl,.SdAB6W_kindSlot,.SdAB6W_kindTag,.SdAB6W_kindTagIcon,.SdAB6W_kindTagLabel,.SdAB6W_turnLabelFull,.SdAB6W_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.SdAB6W_eventColumn,.SdAB6W_kindSlot{transition-property:width}.SdAB6W_event{transition-property:padding-right,padding-left}.SdAB6W_requestBoundaryControl{transition-property:left}.SdAB6W_kindTag{transition-property:padding-right,padding-left}.SdAB6W_kindTagIcon{transition-property:width,opacity,transform}.SdAB6W_kindTagLabel,.SdAB6W_turnLabelFull,.SdAB6W_turnLabelCompact{transition-property:max-width,opacity}}.SdAB6W_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.SdAB6W_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.SdAB6W_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.SdAB6W_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.SdAB6W_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.SdAB6W_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.SdAB6W_promptDiffSection{min-width:0}.SdAB6W_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.SdAB6W_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.SdAB6W_promptDiff span{min-width:max-content;padding:0 6px;display:block}.SdAB6W_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.SdAB6W_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.SdAB6W_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.SdAB6W_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.SdAB6W_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.SdAB6W_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.SdAB6W_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.SdAB6W_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.SdAB6W_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.SdAB6W_table tbody tr[data-collapsed-summary=turn] td,.SdAB6W_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.SdAB6W_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.SdAB6W_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.SdAB6W_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.SdAB6W_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.SdAB6W_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.SdAB6W_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.SdAB6W_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.SdAB6W_resultRequest,.SdAB6W_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.SdAB6W_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.SdAB6W_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.SdAB6W_table tbody tr[data-kind=tool] .SdAB6W_contentText,.SdAB6W_table tbody tr[data-kind=subtool] .SdAB6W_contentText,.SdAB6W_table tbody tr[data-kind=tool] .SdAB6W_resultPreview,.SdAB6W_table tbody tr[data-kind=subtool] .SdAB6W_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.SdAB6W_table tbody tr[data-kind=subtool] .SdAB6W_content{padding-left:26px}.SdAB6W_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.SdAB6W_noOutputText{color:var(--dsw-alias-label-caption)}.SdAB6W_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.SdAB6W_error,.SdAB6W_overview dd.SdAB6W_error,.SdAB6W_details .SdAB6W_errorPayload{color:var(--dsw-alias-state-error-primary)}.SdAB6W_details .SdAB6W_errorPayload .SdAB6W_resultBlockText{color:inherit}.SdAB6W_details .SdAB6W_jsonPayload.SdAB6W_errorPayload,.SdAB6W_details .SdAB6W_jsonPreview.SdAB6W_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.SdAB6W_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.SdAB6W_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.SdAB6W_detailsResizeHandle:focus-visible{outline:none}.SdAB6W_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.SdAB6W_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.SdAB6W_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.SdAB6W_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.SdAB6W_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.SdAB6W_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.SdAB6W_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.SdAB6W_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.SdAB6W_detailTabs::-webkit-scrollbar{display:none}.SdAB6W_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.SdAB6W_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.SdAB6W_detailTabActive{color:var(--dsw-alias-state-business-primary)}.SdAB6W_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.SdAB6W_close:focus-visible,.SdAB6W_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.SdAB6W_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.SdAB6W_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.SdAB6W_detailBodySummary>.SdAB6W_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.SdAB6W_detailBodySummary>.SdAB6W_compactedSummary{flex:1;min-height:0;overflow:auto}.SdAB6W_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.SdAB6W_summaryScrollRegion:hover,.SdAB6W_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.SdAB6W_compactedSummary .SdAB6W_markdownPayload{padding-right:18px}.SdAB6W_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.SdAB6W_overviewParentLinks{gap:14px;display:flex}.SdAB6W_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.SdAB6W_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.SdAB6W_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.SdAB6W_overviewHierarchyNavLink:hover .SdAB6W_overviewHierarchyJumpIconTight,.SdAB6W_overviewHierarchyNavLink:focus-visible .SdAB6W_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.SdAB6W_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.SdAB6W_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.SdAB6W_overview>.SdAB6W_requestTokenDetail dt{padding-left:12px}.SdAB6W_usagePanel{padding:4px 0 10px}.SdAB6W_usageGroup+.SdAB6W_usageGroup{margin-top:8px}.SdAB6W_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.SdAB6W_usageGroup .SdAB6W_overview{padding:0}.SdAB6W_overview dt{color:var(--dsw-alias-label-tertiary)}.SdAB6W_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.SdAB6W_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.SdAB6W_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.SdAB6W_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.SdAB6W_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.SdAB6W_overviewSection+.SdAB6W_overviewSection{padding-top:8px}.SdAB6W_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.SdAB6W_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.SdAB6W_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.SdAB6W_overviewTitle:hover .SdAB6W_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.SdAB6W_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.SdAB6W_overviewTitle:focus-visible .SdAB6W_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.SdAB6W_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.SdAB6W_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.SdAB6W_overviewPreview .SdAB6W_jsonPreview>:first-child,.SdAB6W_overviewPreview .SdAB6W_schemaTree>:first-child{padding-bottom:0}.SdAB6W_overviewPreview .SdAB6W_schemaTree{margin-bottom:0}.SdAB6W_overviewPreview .SdAB6W_overview{padding:2px 0 0}.SdAB6W_overviewPreview .SdAB6W_overview>div{min-height:22px}.SdAB6W_markdownPreview,.SdAB6W_markdownPayload{color:var(--dsw-alias-label-primary)}.SdAB6W_markdownPreview>div,.SdAB6W_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.SdAB6W_markdownPreview>div h1,.SdAB6W_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.SdAB6W_markdownPreview>div h2,.SdAB6W_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.SdAB6W_markdownPreview>div :where(h3,h4,h5,h6),.SdAB6W_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.SdAB6W_markdownPreview>div :not(pre)>code,.SdAB6W_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.SdAB6W_markdownPreview>div table,.SdAB6W_markdownPayload>div table{font:var(--dsw-font-xs-13)}.SdAB6W_markdownPreview>div>:first-child{margin-top:0}.SdAB6W_markdownPreview>div>:last-child{margin-bottom:0}.SdAB6W_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.SdAB6W_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.SdAB6W_markdownPreview>div :where(p,ul,ol){margin:8px 0}.SdAB6W_markdownPreview>div li:not(:first-child){margin-top:3px}.SdAB6W_markdownPreview>div blockquote{margin-top:8px}.SdAB6W_markdownPreview>div hr{margin:14px 0}.SdAB6W_markdownPreview>div>.md-code-block{margin:10px 0}.SdAB6W_assistantContent .SdAB6W_markdownPayload,.SdAB6W_assistantContent .SdAB6W_payload{min-height:0}.SdAB6W_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.SdAB6W_thinkingQuoteOnlyPreview{margin-bottom:8px}.SdAB6W_detailBody>.SdAB6W_assistantContentRendered .SdAB6W_thinkingQuote{margin-top:14px}.SdAB6W_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.SdAB6W_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.SdAB6W_thinkingToggle[aria-expanded=true] .SdAB6W_thinkingChevron{transform:rotate(90deg)}.SdAB6W_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.SdAB6W_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.SdAB6W_thinkingQuote .SdAB6W_markdownPreview,.SdAB6W_thinkingQuote .SdAB6W_markdownPayload,.SdAB6W_thinkingQuote .SdAB6W_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.SdAB6W_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.SdAB6W_markdownPreview{padding:6px 14px 8px}.SdAB6W_markdownPayload{min-height:100%;padding:14px}.SdAB6W_jsonPayload{min-height:100%}.SdAB6W_jsonPreview{min-height:0}.SdAB6W_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.SdAB6W_schemaPreview{min-height:0}.SdAB6W_schemaIntro{padding:12px 14px 6px}.SdAB6W_schemaPreview .SdAB6W_schemaIntro{padding-top:6px}.SdAB6W_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.SdAB6W_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.SdAB6W_schemaParameters{min-width:0}.SdAB6W_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.SdAB6W_schemaTree{margin:0 6px 8px 0}.SdAB6W_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.SdAB6W_payloadPreview{min-height:0;padding:6px 14px 8px}.SdAB6W_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.SdAB6W_sourceBlock+.SdAB6W_sourceBlock{margin-top:14px}.SdAB6W_sourceBlockHeader,.SdAB6W_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.SdAB6W_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.SdAB6W_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.SdAB6W_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.SdAB6W_sourceBlockJumpTarget:hover .SdAB6W_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.SdAB6W_sourceBlockJumpTarget:focus-visible{outline:none}.SdAB6W_sourceBlockJumpTarget:focus-visible .SdAB6W_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.SdAB6W_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.SdAB6W_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.SdAB6W_panelImageLinkPreview{max-height:140px}.SdAB6W_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.SdAB6W_panelImageLinkPreview .SdAB6W_panelImage{max-height:140px}.SdAB6W_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.SdAB6W_messageImagesPreview{gap:6px;margin:6px 14px 8px}.SdAB6W_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.SdAB6W_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.SdAB6W_assistantToolCalls li{min-width:0}.SdAB6W_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.SdAB6W_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.SdAB6W_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.SdAB6W_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.SdAB6W_assistantToolCallButton:hover .SdAB6W_assistantToolCallIcon,.SdAB6W_assistantToolCallButton:focus-visible .SdAB6W_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.SdAB6W_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.SdAB6W_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.SdAB6W_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.SdAB6W_systemPrompt{box-sizing:border-box}.SdAB6W_toolCatalog{min-height:100%;padding:8px 0 16px}.SdAB6W_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.SdAB6W_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.SdAB6W_toolCatalogSummary::-webkit-details-marker{display:none}.SdAB6W_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.SdAB6W_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.SdAB6W_toolCatalogChevron,.SdAB6W_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.SdAB6W_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.SdAB6W_toolCatalogItem[open] .SdAB6W_toolCatalogChevron{transform:rotate(90deg)}.SdAB6W_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.SdAB6W_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.SdAB6W_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.SdAB6W_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.SdAB6W_toolCatalogTree{margin-left:-14px;margin-right:6px}.SdAB6W_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.SdAB6W_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.SdAB6W_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.SdAB6W_overviewPreview .SdAB6W_noPayload{padding:6px 14px 8px}.SdAB6W_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.SdAB6W_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"arrow": "SdAB6W_arrow",
			"assistantContent": "SdAB6W_assistantContent",
			"assistantContentRendered": "SdAB6W_assistantContentRendered",
			"assistantOutput": "SdAB6W_assistantOutput",
			"assistantToolCallArgs": "SdAB6W_assistantToolCallArgs",
			"assistantToolCallButton": "SdAB6W_assistantToolCallButton",
			"assistantToolCallIcon": "SdAB6W_assistantToolCallIcon",
			"assistantToolCallName": "SdAB6W_assistantToolCallName",
			"assistantToolCallText": "SdAB6W_assistantToolCallText",
			"assistantToolCalls": "SdAB6W_assistantToolCalls",
			"assistantToolCallsPreview": "SdAB6W_assistantToolCallsPreview",
			"assistantVioletBright": "SdAB6W_assistantVioletBright",
			"close": "SdAB6W_close",
			"collapsedTurnContent": "SdAB6W_collapsedTurnContent",
			"collapsedTurnEllipsis": "SdAB6W_collapsedTurnEllipsis",
			"collapsedTurnText": "SdAB6W_collapsedTurnText",
			"compacted": "SdAB6W_compacted",
			"compactedSummary": "SdAB6W_compactedSummary",
			"content": "SdAB6W_content",
			"contentColumn": "SdAB6W_contentColumn",
			"contentText": "SdAB6W_contentText",
			"contextGreen": "SdAB6W_contextGreen",
			"detailBody": "SdAB6W_detailBody",
			"detailBodySummary": "SdAB6W_detailBodySummary",
			"detailTab": "SdAB6W_detailTab",
			"detailTabActive": "SdAB6W_detailTabActive",
			"detailTabs": "SdAB6W_detailTabs",
			"details": "SdAB6W_details",
			"detailsHeader": "SdAB6W_detailsHeader",
			"detailsLocation": "SdAB6W_detailsLocation",
			"detailsResizeHandle": "SdAB6W_detailsResizeHandle",
			"detailsTitle": "SdAB6W_detailsTitle",
			"error": "SdAB6W_error",
			"errorPayload": "SdAB6W_errorPayload",
			"event": "SdAB6W_event",
			"eventColumn": "SdAB6W_eventColumn",
			"eventHeader": "SdAB6W_eventHeader",
			"eventInner": "SdAB6W_eventInner",
			"history-loading-spin": "SdAB6W_history-loading-spin",
			"historyLoadButton": "SdAB6W_historyLoadButton",
			"historyLoadRow": "SdAB6W_historyLoadRow",
			"historyLoading": "SdAB6W_historyLoading",
			"historyLoadingBar": "SdAB6W_historyLoadingBar",
			"historyLoadingSpinner": "SdAB6W_historyLoadingSpinner",
			"inlineResult": "SdAB6W_inlineResult",
			"inlineResultText": "SdAB6W_inlineResultText",
			"jsonPayload": "SdAB6W_jsonPayload",
			"jsonPreview": "SdAB6W_jsonPreview",
			"kindSlot": "SdAB6W_kindSlot",
			"kindTag": "SdAB6W_kindTag",
			"kindTagIcon": "SdAB6W_kindTagIcon",
			"kindTagLabel": "SdAB6W_kindTagLabel",
			"markdownPayload": "SdAB6W_markdownPayload",
			"markdownPreview": "SdAB6W_markdownPreview",
			"message": "SdAB6W_message",
			"messageImages": "SdAB6W_messageImages",
			"messageImagesPreview": "SdAB6W_messageImagesPreview",
			"noOutputText": "SdAB6W_noOutputText",
			"noPayload": "SdAB6W_noPayload",
			"overview": "SdAB6W_overview",
			"overviewHeading": "SdAB6W_overviewHeading",
			"overviewHierarchyJumpIconTight": "SdAB6W_overviewHierarchyJumpIconTight",
			"overviewHierarchyNavLink": "SdAB6W_overviewHierarchyNavLink",
			"overviewParentLinks": "SdAB6W_overviewParentLinks",
			"overviewPreview": "SdAB6W_overviewPreview",
			"overviewSection": "SdAB6W_overviewSection",
			"overviewSections": "SdAB6W_overviewSections",
			"overviewTitle": "SdAB6W_overviewTitle",
			"overviewTitleIcon": "SdAB6W_overviewTitleIcon",
			"panelImage": "SdAB6W_panelImage",
			"panelImageLink": "SdAB6W_panelImageLink",
			"panelImageLinkPreview": "SdAB6W_panelImageLinkPreview",
			"payload": "SdAB6W_payload",
			"payloadPreview": "SdAB6W_payloadPreview",
			"promptDiff": "SdAB6W_promptDiff",
			"promptDiffLineadded": "SdAB6W_promptDiffLineadded",
			"promptDiffLinecontext": "SdAB6W_promptDiffLinecontext",
			"promptDiffLinemeta": "SdAB6W_promptDiffLinemeta",
			"promptDiffLineremoved": "SdAB6W_promptDiffLineremoved",
			"promptDiffSection": "SdAB6W_promptDiffSection",
			"promptDiffSections": "SdAB6W_promptDiffSections",
			"promptDiffTitle": "SdAB6W_promptDiffTitle",
			"requestBoundaryControl": "SdAB6W_requestBoundaryControl",
			"requestBoundaryControlActive": "SdAB6W_requestBoundaryControlActive",
			"requestDetailsDot": "SdAB6W_requestDetailsDot",
			"requestDetailsName": "SdAB6W_requestDetailsName",
			"requestTokenDetail": "SdAB6W_requestTokenDetail",
			"resultBlockText": "SdAB6W_resultBlockText",
			"resultBlocks": "SdAB6W_resultBlocks",
			"resultBlocksPreview": "SdAB6W_resultBlocksPreview",
			"resultPreview": "SdAB6W_resultPreview",
			"resultRequest": "SdAB6W_resultRequest",
			"schema": "SdAB6W_schema",
			"schemaDescription": "SdAB6W_schemaDescription",
			"schemaIntro": "SdAB6W_schemaIntro",
			"schemaName": "SdAB6W_schemaName",
			"schemaParameters": "SdAB6W_schemaParameters",
			"schemaParametersTitle": "SdAB6W_schemaParametersTitle",
			"schemaPreview": "SdAB6W_schemaPreview",
			"schemaTree": "SdAB6W_schemaTree",
			"selectionRail": "SdAB6W_selectionRail",
			"sourceBlock": "SdAB6W_sourceBlock",
			"sourceBlockContent": "SdAB6W_sourceBlockContent",
			"sourceBlockHeader": "SdAB6W_sourceBlockHeader",
			"sourceBlockJumpIcon": "SdAB6W_sourceBlockJumpIcon",
			"sourceBlockJumpTarget": "SdAB6W_sourceBlockJumpTarget",
			"sourceBlockLabel": "SdAB6W_sourceBlockLabel",
			"sourceBlocks": "SdAB6W_sourceBlocks",
			"split": "SdAB6W_split",
			"subtoolAmber": "SdAB6W_subtoolAmber",
			"summaryScrollRegion": "SdAB6W_summaryScrollRegion",
			"systemNeutral": "SdAB6W_systemNeutral",
			"systemPrompt": "SdAB6W_systemPrompt",
			"table": "SdAB6W_table",
			"tablePane": "SdAB6W_tablePane",
			"thinkingChevron": "SdAB6W_thinkingChevron",
			"thinkingQuote": "SdAB6W_thinkingQuote",
			"thinkingQuoteOnlyPreview": "SdAB6W_thinkingQuoteOnlyPreview",
			"thinkingToggle": "SdAB6W_thinkingToggle",
			"timestampToggle": "SdAB6W_timestampToggle",
			"toolAmber": "SdAB6W_toolAmber",
			"toolCallNameTypeface": "SdAB6W_toolCallNameTypeface",
			"toolCallOnly": "SdAB6W_toolCallOnly",
			"toolCallPayload": "SdAB6W_toolCallPayload",
			"toolCatalog": "SdAB6W_toolCatalog",
			"toolCatalogChevron": "SdAB6W_toolCatalogChevron",
			"toolCatalogDefinition": "SdAB6W_toolCatalogDefinition",
			"toolCatalogDescription": "SdAB6W_toolCatalogDescription",
			"toolCatalogFullDescription": "SdAB6W_toolCatalogFullDescription",
			"toolCatalogIcon": "SdAB6W_toolCatalogIcon",
			"toolCatalogItem": "SdAB6W_toolCatalogItem",
			"toolCatalogName": "SdAB6W_toolCatalogName",
			"toolCatalogSummary": "SdAB6W_toolCatalogSummary",
			"toolCatalogTree": "SdAB6W_toolCatalogTree",
			"trajectory-table": "SdAB6W_trajectory-table",
			"turnLabel": "SdAB6W_turnLabel",
			"turnLabelActive": "SdAB6W_turnLabelActive",
			"turnLabelCompact": "SdAB6W_turnLabelCompact",
			"turnLabelFull": "SdAB6W_turnLabelFull",
			"turnRail": "SdAB6W_turnRail",
			"usageGroup": "SdAB6W_usageGroup",
			"usageHeading": "SdAB6W_usageHeading",
			"usagePanel": "SdAB6W_usagePanel",
			"user": "SdAB6W_user",
			"virtualSpacer": "SdAB6W_virtualSpacer",
			"visuallyHidden": "SdAB6W_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-trajectory/src/client/TrajectoryToolbar.module.css.mjs
		const css$2 = ".JKIYBW_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.JKIYBW_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.JKIYBW_actions{flex:none;align-items:center;gap:2px;display:flex}.JKIYBW_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.JKIYBW_toggle:hover,.JKIYBW_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.JKIYBW_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.JKIYBW_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.JKIYBW_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.JKIYBW_control[hidden]{display:none}.JKIYBW_control:hover:not(:disabled),.JKIYBW_control[aria-checked=true],.JKIYBW_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.JKIYBW_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.JKIYBW_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.JKIYBW_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.JKIYBW_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.JKIYBW_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.JKIYBW_controlTrack[data-on=true] .JKIYBW_controlThumb{transform:translate(10px)}.JKIYBW_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.JKIYBW_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.JKIYBW_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.JKIYBW_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.JKIYBW_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.JKIYBW_search:hover{border-color:var(--dsw-alias-label-caption)}.JKIYBW_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.JKIYBW_searchIcon{flex:none}.JKIYBW_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.JKIYBW_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.JKIYBW_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"action": "JKIYBW_action",
			"actionIcon": "JKIYBW_actionIcon",
			"actions": "JKIYBW_actions",
			"control": "JKIYBW_control",
			"controlThumb": "JKIYBW_controlThumb",
			"controlTrack": "JKIYBW_controlTrack",
			"inner": "JKIYBW_inner",
			"root": "JKIYBW_root",
			"search": "JKIYBW_search",
			"searchIcon": "JKIYBW_searchIcon",
			"searchInput": "JKIYBW_searchInput",
			"toggle": "JKIYBW_toggle",
			"toggleIcon": "JKIYBW_toggleIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-trajectory/src/client/TrajectoryTimeline.module.css.mjs
		const css$1 = "._4HUvTa_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}._4HUvTa_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}._4HUvTa_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}._4HUvTa_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}._4HUvTa_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}._4HUvTa_labels span:first-child{top:7px}._4HUvTa_labels span:nth-child(2){top:21px}._4HUvTa_labels span:nth-child(3){top:35px}._4HUvTa_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}._4HUvTa_track[data-panning=true]{cursor:grabbing}._4HUvTa_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}._4HUvTa_earlierHistory:hover{opacity:1}._4HUvTa_earlierHistory[aria-disabled=true]{cursor:default}._4HUvTa_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}._4HUvTa_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}._4HUvTa_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._4HUvTa_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}._4HUvTa_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){._4HUvTa_lanes[data-animate-viewport=true],._4HUvTa_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}._4HUvTa_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}._4HUvTa_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}._4HUvTa_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}._4HUvTa_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}._4HUvTa_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}._4HUvTa_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}._4HUvTa_span[data-timeline-span=tool],._4HUvTa_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}._4HUvTa_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}._4HUvTa_span[data-equal-duration=true]{width:8px;min-width:8px}._4HUvTa_span[data-selected=false]{opacity:.2}._4HUvTa_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}._4HUvTa_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}._4HUvTa_span[data-search-match=false]{opacity:.14}._4HUvTa_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}._4HUvTa_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}._4HUvTa_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}._4HUvTa_selectionEdges:before,._4HUvTa_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}._4HUvTa_selectionEdges:before{left:0}._4HUvTa_selectionEdges:after{right:0}._4HUvTa_selectionEdges[data-dragging=true]:before,._4HUvTa_selectionEdges[data-dragging=true]:after{width:2px}._4HUvTa_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"earlierHistory": "_4HUvTa_earlierHistory",
			"empty": "_4HUvTa_empty",
			"hoverLine": "_4HUvTa_hoverLine",
			"labels": "_4HUvTa_labels",
			"lanes": "_4HUvTa_lanes",
			"plot": "_4HUvTa_plot",
			"root": "_4HUvTa_root",
			"selection": "_4HUvTa_selection",
			"selectionEdges": "_4HUvTa_selectionEdges",
			"span": "_4HUvTa_span",
			"track": "_4HUvTa_track",
			"turnBoundaries": "_4HUvTa_turnBoundaries",
			"turnBoundary": "_4HUvTa_turnBoundary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-trajectory/src/client/views.module.css.mjs
		const css = ".XJovPa_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.XJovPa_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
