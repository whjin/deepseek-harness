window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/locale/src/client/LanguageRow.module.css.mjs
		const css = ".U8r6_G_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.U8r6_G_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.U8r6_G_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.U8r6_G_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.U8r6_G_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.U8r6_G_chevron{flex:none}";
		...
		var LanguageRow_module_css_default = {
			"chevron": "U8r6_G_chevron",
			"row": "U8r6_G_row",
			"rowText": "U8r6_G_rowText",
			"selector": "U8r6_G_selector",
			"title": "U8r6_G_title"
		};
		//#endregion
