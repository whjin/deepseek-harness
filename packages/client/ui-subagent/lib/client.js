window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-subagent/src/client/SubagentCatalogAction.module.css.mjs
		const css$1 = ".jtTgmW_root{position:relative}.jtTgmW_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.jtTgmW_count{margin:0 5px}.jtTgmW_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.jtTgmW_trigger:hover,.jtTgmW_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.jtTgmW_trigger svg{transition:transform .12s}.jtTgmW_triggerOpen{transform:rotate(180deg)}.jtTgmW_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.jtTgmW_node{min-width:0;position:relative}.jtTgmW_menu>.jtTgmW_node{margin-left:-3px}.jtTgmW_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.jtTgmW_row:hover>.jtTgmW_clickarea,.jtTgmW_row:focus-visible>.jtTgmW_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.jtTgmW_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.jtTgmW_row>[data-state],.jtTgmW_clickarea>[data-state]{margin-top:4px}.jtTgmW_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.jtTgmW_disabled:hover{background:0 0}.jtTgmW_loadingRow{cursor:default}.jtTgmW_disclosure,.jtTgmW_disclosureSpace{flex:none;width:14px;height:18px}.jtTgmW_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.jtTgmW_disclosure:hover{color:var(--dsw-alias-label-primary)}.jtTgmW_disclosureOpen{transform:rotate(90deg)}.jtTgmW_content{flex-direction:column;flex:1;min-width:0;display:flex}.jtTgmW_label,.jtTgmW_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.jtTgmW_label{color:inherit;font-weight:400}.jtTgmW_summary,.jtTgmW_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.jtTgmW_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.jtTgmW_metricToken{grid-row:1;line-height:18px}.jtTgmW_metricDuration{grid-row:2}.jtTgmW_children{margin-left:18px;padding-left:4px;position:relative}.jtTgmW_children:before,.jtTgmW_children>.jtTgmW_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.jtTgmW_children:before{height:26px;top:-26px}.jtTgmW_children[aria-busy=true]:before{content:none}.jtTgmW_children>.jtTgmW_node:before{top:0;bottom:0;left:-4px}.jtTgmW_children>.jtTgmW_node:last-child:before{height:17px;bottom:auto}.jtTgmW_children>.jtTgmW_node>.jtTgmW_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.jtTgmW_notice,.jtTgmW_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.jtTgmW_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.jtTgmW_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.jtTgmW_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentCatalogAction_module_css_default = {
			"activitySlot": "jtTgmW_activitySlot",
			"children": "jtTgmW_children",
			"clickarea": "jtTgmW_clickarea",
			"content": "jtTgmW_content",
			"count": "jtTgmW_count",
			"disabled": "jtTgmW_disabled",
			"disclosure": "jtTgmW_disclosure",
			"disclosureOpen": "jtTgmW_disclosureOpen",
			"disclosureSpace": "jtTgmW_disclosureSpace",
			"error": "jtTgmW_error",
			"label": "jtTgmW_label",
			"loadingRow": "jtTgmW_loadingRow",
			"menu": "jtTgmW_menu",
			"metricDuration": "jtTgmW_metricDuration",
			"metricToken": "jtTgmW_metricToken",
			"metrics": "jtTgmW_metrics",
			"node": "jtTgmW_node",
			"notice": "jtTgmW_notice",
			"refresh": "jtTgmW_refresh",
			"root": "jtTgmW_root",
			"row": "jtTgmW_row",
			"summary": "jtTgmW_summary",
			"trigger": "jtTgmW_trigger",
			"triggerOpen": "jtTgmW_triggerOpen"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/client/ui-subagent/src/client/SubagentReadOnlyComposer.module.css.mjs
		const css = "._8qFUkW_frame{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}._8qFUkW_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "_8qFUkW_frame" };
		//#endregion
