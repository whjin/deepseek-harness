window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisRunRow.module.css.mjs
		const css$2 = ".DU63qq_card{flex-direction:column;gap:8px;display:flex}.DU63qq_row{align-items:center;min-height:32px;display:flex}.DU63qq_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.DU63qq_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.DU63qq_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.DU63qq_summary,.DU63qq_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.DU63qq_error{color:var(--dsw-alias-state-error-primary)}.DU63qq_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.DU63qq_card[data-cordis-status=awaiting-approval] .DU63qq_status,.DU63qq_card[data-cordis-status=client-pending] .DU63qq_status{color:var(--dsw-alias-state-warn-label)}.DU63qq_card[data-cordis-status=running] .DU63qq_status{color:var(--dsw-alias-state-success-primary)}.DU63qq_card[data-cordis-status=failed] .DU63qq_status{color:var(--dsw-alias-state-error-primary)}.DU63qq_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.DU63qq_card:hover .DU63qq_inspect,.DU63qq_inspect:focus-visible{opacity:1}.DU63qq_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.DU63qq_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.DU63qq_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.DU63qq_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.DU63qq_business .DU63qq_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"business": "DU63qq_business",
			"card": "DU63qq_card",
			"error": "DU63qq_error",
			"icon": "DU63qq_icon",
			"inspect": "DU63qq_inspect",
			"message": "DU63qq_message",
			"output": "DU63qq_output",
			"row": "DU63qq_row",
			"separator": "DU63qq_separator",
			"status": "DU63qq_status",
			"summary": "DU63qq_summary",
			"title": "DU63qq_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisDefineRow.module.css.mjs
		const css$1 = ".hMgUYa_card{flex-direction:column;display:flex}.hMgUYa_card .hMgUYa_title,.hMgUYa_card .hMgUYa_chevron{color:var(--dsw-alias-state-business-primary)}.hMgUYa_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.hMgUYa_row{gap:0}.hMgUYa_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.hMgUYa_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.hMgUYa_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.hMgUYa_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.hMgUYa_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.hMgUYa_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.hMgUYa_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.hMgUYa_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.hMgUYa_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.hMgUYa_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.hMgUYa_switch{height:22px;padding:0 8px;font-size:12px}.hMgUYa_card[data-terminal] .hMgUYa_title,.hMgUYa_card[data-terminal] .hMgUYa_name,.hMgUYa_card[data-terminal] .hMgUYa_purpose,.hMgUYa_card[data-terminal] .hMgUYa_statusLabel{color:var(--dsw-alias-label-caption)}.hMgUYa_card[data-terminal] .hMgUYa_separator{background:var(--dsw-alias-label-caption)}.hMgUYa_bodyWrap{flex-direction:column;display:flex}.hMgUYa_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.hMgUYa_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.hMgUYa_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.hMgUYa_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.hMgUYa_sourceTab:disabled{cursor:default;opacity:.4}.hMgUYa_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.hMgUYa_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.hMgUYa_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.hMgUYa_sourcePanel{max-height:260px;overflow:auto}.hMgUYa_sourceCode{margin:0}.hMgUYa_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.hMgUYa_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.hMgUYa_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.hMgUYa_output[data-error]{color:var(--dsw-alias-state-error-primary)}.hMgUYa_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.hMgUYa_card:hover .hMgUYa_inspectButton,.hMgUYa_inspectButton:focus-visible{opacity:1}.hMgUYa_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.hMgUYa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.hMgUYa_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"approvalPrompt": "hMgUYa_approvalPrompt",
			"bodyWrap": "hMgUYa_bodyWrap",
			"card": "hMgUYa_card",
			"chevron": "hMgUYa_chevron",
			"codeSection": "hMgUYa_codeSection",
			"errorSummary": "hMgUYa_errorSummary",
			"inspectButton": "hMgUYa_inspectButton",
			"name": "hMgUYa_name",
			"notice": "hMgUYa_notice",
			"output": "hMgUYa_output",
			"panelHint": "hMgUYa_panelHint",
			"purpose": "hMgUYa_purpose",
			"readout": "hMgUYa_readout",
			"requestError": "hMgUYa_requestError",
			"row": "hMgUYa_row",
			"sectionLabel": "hMgUYa_sectionLabel",
			"separator": "hMgUYa_separator",
			"sourceCard": "hMgUYa_sourceCard",
			"sourceCode": "hMgUYa_sourceCode",
			"sourcePanel": "hMgUYa_sourcePanel",
			"sourceTab": "hMgUYa_sourceTab",
			"sourceTabActive": "hMgUYa_sourceTabActive",
			"sourceTabs": "hMgUYa_sourceTabs",
			"statusLabel": "hMgUYa_statusLabel",
			"switch": "hMgUYa_switch",
			"title": "hMgUYa_title",
			"visuallyHidden": "hMgUYa_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/whjin/Software/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisPanel.module.css.mjs
		const css = ".oPRA-q_layer{flex:none;align-items:center;width:100%;height:42px;margin:8px 0 0;display:flex;position:relative}.oPRA-q_footerButtons{align-items:center;width:100%;display:flex}.oPRA-q_badge{width:calc(100% + 4px);height:42px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;margin:0 -2px;padding:0 10px 0 8px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.oPRA-q_badge:hover,.oPRA-q_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.oPRA-q_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.oPRA-q_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.oPRA-q_layer.oPRA-q_rail{width:36px;height:36px;margin:0}.oPRA-q_rail .oPRA-q_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.oPRA-q_rail .oPRA-q_footerButtons{flex-direction:column;gap:2px}.oPRA-q_panel{z-index:30;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;overflow:hidden}.oPRA-q_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.oPRA-q_body{flex:1;min-height:0;padding:0 12px 12px;overflow-y:auto}.oPRA-q_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:20px}.oPRA-q_note,.oPRA-q_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.oPRA-q_readError{color:var(--dsw-alias-state-error-primary)}.oPRA-q_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0;font-size:11px;font-weight:500;line-height:16px}.oPRA-q_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.oPRA-q_row{border:1px solid var(--dsw-alias-border-l2);border-radius:12px;flex-direction:column;gap:8px;padding:14px 12px 10px;display:flex}.oPRA-q_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.oPRA-q_rowHead{align-items:center;gap:8px;display:flex}.oPRA-q_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.oPRA-q_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.oPRA-q_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.oPRA-q_row[data-cordis-status=idle] .oPRA-q_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.oPRA-q_row[data-cordis-status=awaiting-approval] .oPRA-q_rowStatus,.oPRA-q_row[data-cordis-status=client-pending] .oPRA-q_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.oPRA-q_row[data-cordis-status=failed] .oPRA-q_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.oPRA-q_row[data-cordis-status=running] .oPRA-q_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.oPRA-q_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.oPRA-q_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.oPRA-q_versionPicker select{border:1px solid var(--dsw-alias-border-l2);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;background:0 0;border-radius:7px;flex:1;padding:0 8px}.oPRA-q_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.oPRA-q_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.oPRA-q_rowActions{flex:none;align-items:center;gap:10px;display:flex}.oPRA-q_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.oPRA-q_transitionActions{gap:6px;margin-left:auto;display:flex}.oPRA-q_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.oPRA-q_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.oPRA-q_transitionActions button:disabled{opacity:.4;cursor:default}.oPRA-q_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.oPRA-q_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.oPRA-q_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.oPRA-q_actionButton:disabled{opacity:.4;cursor:default}.oPRA-q_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.oPRA-q_doubleCheck svg{position:absolute;top:1px}.oPRA-q_doubleCheck svg:first-child{opacity:.7;left:0}.oPRA-q_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"actionButton": "oPRA-q_actionButton",
			"activeVersion": "oPRA-q_activeVersion",
			"badge": "oPRA-q_badge",
			"badgeCount": "oPRA-q_badgeCount",
			"badgeLabel": "oPRA-q_badgeLabel",
			"body": "oPRA-q_body",
			"doubleCheck": "oPRA-q_doubleCheck",
			"footerButtons": "oPRA-q_footerButtons",
			"group": "oPRA-q_group",
			"header": "oPRA-q_header",
			"layer": "oPRA-q_layer",
			"note": "oPRA-q_note",
			"panel": "oPRA-q_panel",
			"rail": "oPRA-q_rail",
			"readError": "oPRA-q_readError",
			"row": "oPRA-q_row",
			"rowActions": "oPRA-q_rowActions",
			"rowDetail": "oPRA-q_rowDetail",
			"rowError": "oPRA-q_rowError",
			"rowHead": "oPRA-q_rowHead",
			"rowId": "oPRA-q_rowId",
			"rowName": "oPRA-q_rowName",
			"rowPurpose": "oPRA-q_rowPurpose",
			"rowStatus": "oPRA-q_rowStatus",
			"rows": "oPRA-q_rows",
			"title": "oPRA-q_title",
			"transition": "oPRA-q_transition",
			"transitionActions": "oPRA-q_transitionActions",
			"versionPicker": "oPRA-q_versionPicker"
		};
		//#endregion
